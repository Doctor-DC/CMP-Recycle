...
from SDK.openstack.clustering.v1 import action as _action
from SDK.openstack.clustering.v1 import build_info
from SDK.openstack.clustering.v1 import cluster as _cluster
from SDK.openstack.clustering.v1 import cluster_attr as _cluster_attr
from SDK.openstack.clustering.v1 import cluster_policy as _cluster_policy
from SDK.openstack.clustering.v1 import event as _event
from SDK.openstack.clustering.v1 import node as _node
from SDK.openstack.clustering.v1 import policy as _policy
from SDK.openstack.clustering.v1 import policy_type as _policy_type
from SDK.openstack.clustering.v1 import profile as _profile
from SDK.openstack.clustering.v1 import profile_type as _profile_type
from SDK.openstack.clustering.v1 import receiver as _receiver
from SDK.openstack.clustering.v1 import service as _service
...
class Proxy(proxy.Proxy):
    ...
    def profile_types(self, **query):
        ...
        :returns: A generator of objects that are of type
                  :class:`~SDK.openstack.clustering.v1.profile_type.ProfileType`
        """
    ...
    def get_profile_type(self, profile_type):
        ...
        :param profile_type: The name of the profile_type to retrieve or an
         object of :class:`~SDK.openstack.clustering.v1.profile_type.ProfileType`.

        :returns: A :class:`~SDK.openstack.clustering.v1.profile_type.ProfileType`
                  object.
    ...
    def policy_types(self, **query):
        ...
        :returns: A generator of objects that are of type
                  :class:`~SDK.openstack.clustering.v1.policy_type.PolicyType`
        """
    ...
    def get_policy_type(self, policy_type):
        ...
        :returns: A :class:`~SDK.openstack.clustering.v1.policy_type.PolicyType`
                  object.
        :raises: :class:`~SDK.openstack.exceptions.ResourceNotFound` when no
    ...
    def create_profile(self, **attrs):
        ...
        :param dict attrs: Keyword arguments that will be used to create a
             :class:`~SDK.openstack.clustering.v1.profile.Profile`, it is comprised
             of the properties on the Profile class.

        :returns: The results of profile creation.
        :rtype: :class:`~SDK.openstack.clustering.v1.profile.Profile`.
        """
    ...
    def delete_profile(self, profile, ignore_missing=True):
        ...
        :param profile: The value can be either the name or ID of a profile or
            a :class:`~SDK.openstack.clustering.v1.profile.Profile` instance.
    ...
    def find_profile(self, name_or_id, ignore_missing=True):
        ...
        :returns: One :class:`~SDK.openstack.clustering.v1.profile.Profile` object
            or None
        """
    ...
    def get_profile(self, profile):
        ...
        :param profile: The value can be the name or ID of a profile or a
            :class:`~SDK.openstack.clustering.v1.profile.Profile` instance.

        :returns: One :class:`~SDK.openstack.clustering.v1.profile.Profile`
        :raises: :class:`~SDK.openstack.exceptions.ResourceNotFound` when no
    ...
    def update_profile(self, profile, **attrs):
        ...
        :param profile: Either the name or the ID of the profile, or an
            instance of :class:`~SDK.openstack.clustering.v1.profile.Profile`.
    ...
    def validate_profile(self, **attrs):
        ...
        :param dict attrs: Keyword arguments that will be used to create a
             :class:`~SDK.openstack.clustering.v1.profile.ProfileValidate`, it is
             comprised of the properties on the Profile class.

        :returns: The results of profile validation.
        :rtype: :class:`~SDK.openstack.clustering.v1.profile.ProfileValidate`.
        """
    ...
    def create_cluster(self, **attrs):
        ...
        :param dict attrs: Keyword arguments that will be used to create a
             :class:`~SDK.openstack.clustering.v1.cluster.Cluster`, it is comprised
             of the properties on the Cluster class.

        :returns: The results of cluster creation.
        :rtype: :class:`~SDK.openstack.clustering.v1.cluster.Cluster`.
        """
    ...
    def delete_cluster(self, cluster, ignore_missing=True, force_delete=False):
        ...
        :param cluster: The value can be either the name or ID of a cluster or
            a :class:`~SDK.openstack.cluster.v1.cluster.Cluster` instance.
        :param bool ignore_missing: When set to ``False``, an exception
            :class:`~SDK.openstack.exceptions.ResourceNotFound` will be raised when
        ...
        :rtype: :class:`~SDK.openstack.cluster.v1.cluster.Cluster`.
        """
        if force_delete:
    ...
    def find_cluster(self, name_or_id, ignore_missing=True):
        ...
        :param bool ignore_missing: When set to ``False``
                    ...
                    When set to ``True``, None will be returned when
                    attempting to find a nonexistent resource.
        :returns: One :class:`~SDK.openstack.clustering.v1.cluster.Cluster` object
            or None
        """
    ...
    def get_cluster(self, cluster):
        ...
        :param cluster: The value can be the name or ID of a cluster or a
            :class:`~SDK.openstack.clustering.v1.cluster.Cluster` instance.

        :returns: One :class:`~SDK.openstack.clustering.v1.cluster.Cluster`
        :raises: :class:`~SDK.openstack.exceptions.ResourceNotFound` when no
    ...
    def update_cluster(self, cluster, **attrs):
        ...
        :param cluster: Either the name or the ID of the cluster, or an
            instance of :class:`~SDK.openstack.clustering.v1.cluster.Cluster`.
    ...
    def create_node(self, **attrs):
        ...
        :param dict attrs: Keyword arguments that will be used to create a
             :class:`~SDK.openstack.clustering.v1.node.Node`, it is comprised
             of the properties on the ``Node`` class.

        :returns: The results of node creation.
        :rtype: :class:`~SDK.openstack.clustering.v1.node.Node`.
        """
    ...
    def delete_node(self, node, ignore_missing=True, force_delete=False):
        ...
        :param node: The value can be either the name or ID of a node or a
            :class:`~SDK.openstack.cluster.v1.node.Node` instance.
        :param bool ignore_missing: When set to ``False``, an exception
            :class:`~SDK.openstack.exceptions.ResourceNotFound` will be raised when
        ...
        :rtype: :class:`~SDK.openstack.cluster.v1.node.Node`.
        """
        if force_delete:
    ...
    def find_node(self, name_or_id, ignore_missing=True):
        ...
        :returns: One :class:`~SDK.openstack.clustering.v1.node.Node` object
                  or None.
        """
    ...
    def get_node(self, node, details=False):
        ...
        :param node: The value can be the name or ID of a node or a
            :class:`~SDK.openstack.clustering.v1.node.Node` instance.
        ...
        :returns: One :class:`~SDK.openstack.clustering.v1.node.Node`
        :raises: :class:`~SDK.openstack.exceptions.ResourceNotFound` when no
    ...
    def update_node(self, node, **attrs):
        ...
        :param node: Either the name or the ID of the node, or an instance
            of :class:`~SDK.openstack.clustering.v1.node.Node`.
    ...
    def adopt_node(self, preview=False, **attrs):
        ...
        :returns: The result of node adoption. If `preview` is set to False
            (default), returns a :class:`~SDK.openstack.clustering.v1.node.Node`
    ...
    def create_policy(self, **attrs):
        ...
        :param dict attrs: Keyword arguments that will be used to create a
             :class:`~SDK.openstack.clustering.v1.policy.Policy`, it is comprised
             of the properties on the ``Policy`` class.

        :returns: The results of policy creation.
        :rtype: :class:`~SDK.openstack.clustering.v1.policy.Policy`.
        """
    ...
    def delete_policy(self, policy, ignore_missing=True):
        ...
        :param policy: The value can be either the name or ID of a policy or a
            :class:`~SDK.openstack.clustering.v1.policy.Policy` instance.
        :param bool ignore_missing: When set to ``False``, an exception
            :class:`~SDK.openstack.exceptions.ResourceNotFound` will be raised when
    ...
    def update_policy(self, policy, **attrs):
        ...
        :param policy: Either the name or the ID of a policy, or an instance
            of :class:`~SDK.openstack.clustering.v1.policy.Policy`.
    ...
    def validate_policy(self, **attrs):
        ...
        :param dict attrs: Keyword arguments that will be used to create a
             :class:`~SDK.openstack.clustering.v1.policy.PolicyValidate`, it is
             comprised of the properties on the Policy class.

        :returns: The results of Policy validation.
        :rtype: :class:`~SDK.openstack.clustering.v1.policy.PolicyValidate`.
        """
    ...
    def get_cluster_policy(self, cluster_policy, cluster):
        ...
        :rtype: :class:`~SDK.openstack.clustering.v1.cluster_policy.CLusterPolicy`
        :raises: :class:`~SDK.openstack.exceptions.ResourceNotFound` when no
    ...
    def create_receiver(self, **attrs):
        ...
        :param dict attrs: Keyword arguments that will be used to create a
             :class:`~SDK.openstack.clustering.v1.receiver.Receiver`, it is
             comprised of the properties on the Receiver class.

        :returns: The results of receiver creation.
        :rtype: :class:`~SDK.openstack.clustering.v1.receiver.Receiver`.
        """
    ...
    def update_receiver(self, receiver, **attrs):
        ...
        :param receiver: The value can be either the name or ID of a receiver
            or a :class:`~SDK.openstack.clustering.v1.receiver.Receiver` instance.
    ...
    def get_receiver(self, receiver):
        ...
        :param receiver: The value can be the name or ID of a receiver or a
            :class:`~SDK.openstack.clustering.v1.receiver.Receiver` instance.
    ...
    def get_action(self, action):
        ...
        :param action: The value can be the name or ID of an action or a
            :class:`~SDK.openstack.clustering.v1.action.Action` instance.

        :returns: an action object.
        :rtype: :class:`~SDK.openstack.clustering.v1.action.Action`
        :raises: :class:`~SDK.openstack.exceptions.ResourceNotFound` when no
    ...
    def get_event(self, event):
        ...
        :param event: The value can be the name or ID of an event or a
            :class:`~SDK.openstack.clustering.v1.event.Event` instance.

        :returns: an event object.
        :rtype: :class:`~SDK.openstack.clustering.v1.event.Event`
        :raises: :class:`~SDK.openstack.exceptions.ResourceNotFound` when no
    ...
    def services(self, **query):
        ...
        :returns: A generator of objects that are of type
                  :class:`~SDK.openstack.clustering.v1.service.Service`
        """
